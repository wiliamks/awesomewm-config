...
local brightness = require("ui.notifs.brightness")
local volume = require("ui.notifs.volume")
...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({}, "XF86AudioRaiseVolume",
              function() 
		  --awful.spawn("bash -c '~/.scripts/notify/change-volume up'")
		  volume:up()
	      end,
              {description = "increase volume", group = "awesome"}),
    awful.key({}, "XF86AudioLowerVolume",
              function() 
		  --awful.spawn("bash -c '~/.scripts/notify/change-volume down'")
		  volume:down()
	      end,
              {description = "decrease volume", group = "awesome"}),
    awful.key({}, "XF86AudioMute", function() 
		  --awful.spawn("bash -c '~/.scripts/notify/change-volume mute'")
		  volume:mute()
	      end,
...
awful.keyboard.append_global_keybindings({
    ...
    function() awful.spawn("bash -c '~/.config/rofi/scripts/powermenu.sh'") end, {description = "powermenu"}),
})
