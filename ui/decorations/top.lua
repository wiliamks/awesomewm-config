...
local get_titlebar = function(c, height)
    ...
    local min = create_title_button(c, beautiful.xcolor4,
                                    beautiful.xcolor0 .. "55", ci(12, 12))
    min:connect_signal("button::press",
	function()
	    awful.spawn('xdotool key super+n')
	    --c.minimized = true
	end)
    local max = create_title_button(c, beautiful.xcolor5,
                                    beautiful.xcolor0 .. "55", ci(12, 12))
    max:connect_signal("button::press",
        function()
	    --awful.spawn('xdotool key super+m')
